...
* This leaves 4 liters remainging in the 5-liter bucket.

## Additional notes:  

#### I considered recreating this programmically in a visual sense.  i.e. Using arrays, looping through them and adding liters and removing them as necessary.  However, I chose to incorporate a function that calculates the amount dynamicallly using only math.  It is more performant at 3 lines of code versus building arrays and looping through them with 30 lines of code.

###  Now you, too, can diffuse a bomb like Bruce Willis.
